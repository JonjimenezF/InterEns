...
export const routes: Routes = [
  ...
  { path: 'auth/callback', loadComponent: () => import('./auth-callback/auth-callback.page').then(m => m.AuthCallbackPage) },
  { path: 'auth/reset', loadComponent: () => import('./auth-callback/auth-reset.page').then(m => m.AuthResetPage) },
