...
//     { nombre: 'Intercambia un producto', condicion: 'Completa un intercambio', puntos: 100 },
...
//   // 🔄 Método reutilizable (otras páginas pueden llamarlo después de registrar acción)
//   async refrescarMisiones() {
//     console.log('♻️ Refrescando misiones manualmente...');
//     await this.cargarMisiones();
//   }

//   // 📊 Carga las misiones desde el backend y calcula progreso
//   cargarMisiones() {
//     if (!this.usuarioId) return;

//     this.cargando = true;

//     // 🚫 Evita resultados cacheados
...
//         // ✨ Mostrar animación si hay progreso o puntos nuevos
//         const progresoAnterior = this.misiones.some((m) => m.porcentaje > 0);
//         if (this.puntosTotales > puntosAntes || progresoAnterior) {
...
//   // ✨ Animación cuando se gana una misión o sube progreso
//   mostrarAnimacion() {
