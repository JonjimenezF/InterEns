...
//         // Si hay región cargada, cargar sus comunas
//         if (this.enser.region_id) {
//           this.comunas = await this.ubicacionService.getComunasPorRegion(this.enser.region_id);
//         }
//       }
//     } catch (error) {
//       console.error('[SPRODUCTO] Error en ngOnInit:', error);
...
//     this.enser.region_id = regionId;

//     if (!regionId) {
//       this.comunas = [];
//       this.enser.comuna_id = null;
//       return;
//     }
...
//     this.enser.comuna_id = event.detail.value;
//     console.log('📍 Comuna seleccionada:', this.enser.comuna_id);
//   }
...
//       const imageUrls = await this.uploadAllImages();
//       const imagenPorDefecto = 'assets/img/default.png';
//       this.enser.imagen_url = imageUrls[0] || imagenPorDefecto;
//       this.enser.imagenes_extra = [...(this.enser.imagenes_extra || []), ...imageUrls];
//       this.enser.estado = 'publicado';

//       console.log('📤 Enviando enser al backend:', this.enser);
